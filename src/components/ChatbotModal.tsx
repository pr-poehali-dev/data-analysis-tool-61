      ...
      >
        ...
        <div className="h-[80vh] w-full overflow-hidden rounded-lg flex items-center justify-center bg-gray-900">
          <div className="text-center text-white p-8">
            <p className="text-xl mb-4">ИИ-консультант по UX</p>
            <p className="text-gray-400">Здесь появится ИИ-ассистент по вопросам проектирования интерфейсов.</p>
            <p className="text-gray-500 mt-4 text-sm">Задайте вопрос через форму обратной связи ниже.</p>
          </div>
        </div>
      </div>
    </div>
